...
[List of events](https://godoc.org/github.com/KYVENetwork/dydx-cometbft/types#pkg-constants)
...
section](https://github.com/KYVENetwork/dydx-cometbft/blob/v0.38.x/spec/abci/abci++_methods.md#endblock) in
the ABCI spec).
...
```json
{
    ...
    "result": {
        ...
        "data": {
            "type": "dydxcometbft/event/ValidatorSetUpdates",
            "value": {
              "validator_updates": [
                {
