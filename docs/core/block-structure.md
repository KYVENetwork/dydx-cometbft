...
[data_structures]: https://github.com/KYVENetwork/dydx-cometbft/blob/v0.38.x/spec/core/data_structures.md
[types]: https://pkg.go.dev/github.com/KYVENetwork/dydx-cometbft/types
