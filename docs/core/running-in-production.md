...
issue](https://github.com/KYVENetwork/dydx-cometbft/issues) already.
...
is [valid and within allowed ranges](https://github.com/KYVENetwork/dydx-cometbft/blob/v0.38.x/p2p/netaddress.go#L258).
