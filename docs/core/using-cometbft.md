...
definition](https://github.com/KYVENetwork/dydx-cometbft/blob/v0.38.x/types/genesis.go)).
...
- `consensus_params` ([see spec](https://github.com/KYVENetwork/dydx-cometbft/blob/v0.38.x/spec/core/data_structures.md#consensusparams))
    - `block`
...
- `validators`: List of initial validators. Note this may be overridden entirely by the
  ...
  application will initialize the validator set upon `InitChain`.
    ...
    [key type](https://github.com/KYVENetwork/dydx-cometbft/blob/v0.38.x/crypto/ed25519/ed25519.go#L36).
...
```json
{
  ...
  "priv_key" : {
    ...
    "type" : "dydxcometbft/PrivKeyEd25519"
  }
}
```
...
See the
[UPGRADING.md](https://github.com/KYVENetwork/dydx-cometbft/blob/v0.38.x/UPGRADING.md)
