...
To learn about application development on CometBFT, see the [Application Blockchain Interface](https://github.com/KYVENetwork/dydx-cometbft/tree/v0.38.x/spec/abci).
