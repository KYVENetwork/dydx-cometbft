...
code can be found
[here](https://github.com/KYVENetwork/dydx-cometbft/blob/v0.38.x/abci/example/kvstore/kvstore.go).
...
Golang](https://github.com/KYVENetwork/dydx-cometbft/tree/v0.38.x/abci/server). See the
