...
(ABCI)](https://github.com/KYVENetwork/dydx-cometbft/tree/v0.38.x/abci)
...
Types](https://github.com/KYVENetwork/dydx-cometbft/blob/v0.38.x/proto/tendermint/abci/types.proto).
