...
## Support
  ...
  |              | [CometBFT](https://github.com/KYVENetwork/dydx-cometbft/) | [Tendermint-Rs](https://github.com/informalsystems/tendermint-rs) |
  |--------------|:----------------------------------------------------------:|:----------------------------------------------------------------:|
  | JSON-RPC 2.0 |                             ✅                              |                                ✅                                 |
  | HTTP         |                             ✅                              |                                ✅                                 |
  | HTTPS        |                             ✅                              |                                ❌                                 |
  ...
  | Routes                                  | [CometBFT](https://github.com/KYVENetwork/dydx-cometbft/) | [Tendermint-Rs](https://github.com/informalsystems/tendermint-rs) |
  |-----------------------------------------|:----------------------------------------------------------:|:-----------------------------------------------------------------:|
  | [Health](#health)                       |                             ✅                              |                                 ✅                                 |
  | [Status](#status)                       |                             ✅                              |                                 ✅                                 |
  | [NetInfo](#netinfo)                     |                             ✅                              |                                 ✅                                 |
