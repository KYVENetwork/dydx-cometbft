...
All ABCI++ messages and methods are defined in [protocol buffers](https://github.com/KYVENetwork/dydx-cometbft/blob/v0.38.x/proto/tendermint/abci/types.proto).
