...
// source: dydxcometbft/crypto/proof.proto
...
func (*Proof) Descriptor() ([]byte, []int) {
	return fileDescriptor_2be8e21a2ef742e1, []int{0}
}
...
func (*ValueOp) Descriptor() ([]byte, []int) {
	return fileDescriptor_2be8e21a2ef742e1, []int{1}
}
...
func (*DominoOp) Descriptor() ([]byte, []int) {
	return fileDescriptor_2be8e21a2ef742e1, []int{2}
}
...
func (*ProofOp) Descriptor() ([]byte, []int) {
	return fileDescriptor_2be8e21a2ef742e1, []int{3}
}
...
func (*ProofOps) Descriptor() ([]byte, []int) {
	return fileDescriptor_2be8e21a2ef742e1, []int{4}
}
...
func init() {
	proto.RegisterType((*Proof)(nil), "dydxcometbft.crypto.Proof")
	proto.RegisterType((*ValueOp)(nil), "dydxcometbft.crypto.ValueOp")
	proto.RegisterType((*DominoOp)(nil), "dydxcometbft.crypto.DominoOp")
	proto.RegisterType((*ProofOp)(nil), "dydxcometbft.crypto.ProofOp")
	proto.RegisterType((*ProofOps)(nil), "dydxcometbft.crypto.ProofOps")
}

func init() { proto.RegisterFile("dydxcometbft/crypto/proof.proto", fileDescriptor_2be8e21a2ef742e1) }

var fileDescriptor_2be8e21a2ef742e1 = []byte{
	// 371 bytes of a gzipped FileDescriptorProto
	,
}
