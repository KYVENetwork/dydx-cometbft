...
This release fixes two security issues, including ([ASA-2025-003](https://github.com/KYVENetwork/dydx-cometbft/security/advisories/GHSA-hrhf-2vcr-ghch)).
...
- `[consensus]` Reject oversized proposals
  ([\#5324](https://github.com/KYVENetwork/dydx-cometbft/pull/5324))
- `[store]` Prune extended commits properly
  ([5275](https://github.com/KYVENetwork/dydx-cometbft/issues/5275))
- `[bits]` Validate BitArray mismatched Bits and Elems length
  ([ASA-2025-003](https://github.com/KYVENetwork/dydx-cometbft/security/advisories/GHSA-hrhf-2vcr-ghch))
...
- Adds metrics that emit precommit data; precommit quorum delay from proposal, and precommit vote count and stake weight within timeout commit period.
  ([\#5251](https://github.com/KYVENetwork/dydx-cometbft/issues/5251))
...
- `[blocksync]` Ban peer if it reports height lower than what was previously reported
  ([ASA-2025-001](https://github.com/KYVENetwork/dydx-cometbft/security/advisories/GHSA-22qq-3xwm-r5x4))
- `[types]` Check that `Part.Index` equals `Part.Proof.Index`
  ([ASA-2025-001](https://github.com/KYVENetwork/dydx-cometbft/security/advisories/GHSA-r3r4-g7hq-pq4f))

### DEPENDENCIES

- `[go/runtime]` Bump minimum Go version to 1.22.11
  ([\#4891](https://github.com/KYVENetwork/dydx-cometbft/pull/4891))
...
properly handle this change.
  ([\#4521](https://github.com/KYVENetwork/dydx-cometbft/pull/4521))
...
to `1.22.7` by reverting [\#4297](https://github.com/KYVENetwork/dydx-cometbft/pull/4297).
...
logic that were part of `v0.38.14`. For more details, please refer to [ASA-2024-011](https://github.com/KYVENetwork/dydx-cometbft/security/advisories/GHSA-p7mv-53f2-4cwj).
...
[ASA-2024-011](https://github.com/KYVENetwork/dydx-cometbft/security/advisories/GHSA-p7mv-53f2-4cwj).
...
- `[consensus]` Do not panic if the validator index of a `Vote` message is out
  ...
  ([\#ABC-0021](https://github.com/KYVENetwork/dydx-cometbft/security/advisories/GHSA-p7mv-53f2-4cwj))

### DEPENDENCIES

- Bump cometbft-db version to v0.15.0
  ([\#4297](https://github.com/KYVENetwork/dydx-cometbft/pull/4297))
...
- `[p2p]` fix exponential backoff logic to increase reconnect retries close to 24 hours
 ([\#3519](https://github.com/KYVENetwork/dydx-cometbft/issues/3519))
...
- `[metrics]` Call unused `rejected_txs` metric in mempool
  ([\#4019](https://github.com/KYVENetwork/dydx-cometbft/pull/4019))
- `[state/indexer]` Fix the tx_search results not returning all results by changing the logic in the indexer to copy the key and values instead of reusing an iterator. This issue only arises when upgrading to cometbft-db v0.13 or later.
  ([\#4295](https://github.com/KYVENetwork/dydx-cometbft/issues/4295)). Special thanks to @faddat for reporting the issue.

### DEPENDENCIES

- `[go/runtime]` Bump Go version to 1.22
  ([\#4073](https://github.com/KYVENetwork/dydx-cometbft/pull/4073))
- Bump cometbft-db version to v0.14.1
  ([\#4321](https://github.com/KYVENetwork/dydx-cometbft/pull/4321))

### FEATURES

- `[crypto]` use decred secp256k1 directly ([#4294](https://github.com/KYVENetwork/dydx-cometbft/pull/4294))
...
- `[log]` Change "mempool is full" log to debug level
  ([\#4123](https://github.com/KYVENetwork/dydx-cometbft/pull/4123)) Special thanks to @yihuang.
...
- `[light]` Cross-check proposer priorities in retrieved validator sets
  ([\#ASA-2024-009](https://github.com/KYVENetwork/dydx-cometbft/security/advisories/GHSA-g5xx-c4hv-9ccc))
- `[privval]` Ignore duplicate privval listen when already connected ([\#3828](https://github.com/KYVENetwork/dydx-cometbft/issues/3828)
...
- `[crypto/secp256k1]` Adjust to breaking interface changes in
  ...
  ([\#3728](https://github.com/KYVENetwork/dydx-cometbft/pull/3728))
- pinned mockery's version to v2.49.2 to prevent potential
  changes in mocks after each new release of mockery
  ([\#4605](https://github.com/KYVENetwork/dydx-cometbft/pull/4605))
...
- `[e2e]` Add `log_level` option to manifest file
  ([#3819](https://github.com/KYVENetwork/dydx-cometbft/pull/3819)).
- `[e2e]` Add `log_format` option to manifest file
  ([#3836](https://github.com/KYVENetwork/dydx-cometbft/issues/3836)).
...
- `[types]` Only check IFF vote is a non-nil Precommit if extensionsEnabled
  types ([\#3565](https://github.com/KYVENetwork/dydx-cometbft/issues/3565))

### IMPROVEMENTS

- `[indexer]` Fixed ineffective select break statements; they now
  point to their enclosing for loop label to exit
  ([\#3544](https://github.com/KYVENetwork/dydx-cometbft/issues/3544))
...
- `[p2p]` Node respects configured `max_num_outbound_peers` limit when dialing
  ...
  ([\#486](https://github.com/KYVENetwork/dydx-cometbft/issues/486))
- `[rpc]` Fix an issue where a legacy ABCI response, created on `v0.37` or before, is not returned properly in `v0.38` and up
  ...
  ([\#3002](https://github.com/KYVENetwork/dydx-cometbft/issues/3002))
- `[blocksync]` Do not stay in blocksync if the node's validator voting power
  ...
  ([\#3406](https://github.com/KYVENetwork/dydx-cometbft/pull/3406))

### IMPROVEMENTS

- `[p2p/conn]` Update send monitor, used for sending rate limiting, once per batch of packets sent
  ([\#3382](https://github.com/KYVENetwork/dydx-cometbft/pull/3382))
- `[libs/pubsub]` Allow dash (`-`) in event tags
  ([\#3401](https://github.com/KYVENetwork/dydx-cometbft/issues/3401))
- `[p2p/conn]` Remove the usage of a synchronous pool of buffers in secret connection, storing instead the buffer in the connection struct. This reduces the synchronization primitive usage, speeding up the code.
  ([\#3403](https://github.com/KYVENetwork/dydx-cometbft/issues/3403))
...
- `[mempool]` Revert adding the method `PreUpdate()` to the `Mempool` interface, recently introduced
  ...
  ([\#3361](https://github.com/KYVENetwork/dydx-cometbft/pull/3361))

### BUG FIXES

- `[rpc]` Fix nil pointer error in `/tx` and `/tx_search` when block is
  absent ([\#3352](https://github.com/KYVENetwork/dydx-cometbft/issues/3352))
...
- `[mempool]` Add to the `Mempool` interface a new method `PreUpdate()`. This method should be
  ...
  ([\#3314](https://github.com/KYVENetwork/dydx-cometbft/pull/3314))

### BUG FIXES

- `[blockstore]` Added peer banning in blockstore
  ([\#ABC-0013](https://github.com/KYVENetwork/dydx-cometbft/security/advisories/GHSA-hg58-rf2h-6rr7))
- `[blockstore]` Send correct error message when vote extensions do not align with received packet
  ([\#ABC-0014](https://github.com/KYVENetwork/dydx-cometbft/security/advisories/GHSA-hg58-rf2h-6rr7))
- [`mempool`] Fix data race when rechecking with async ABCI client
  ([\#1827](https://github.com/KYVENetwork/dydx-cometbft/issues/1827))
- `[consensus]` Fix a race condition in the consensus timeout ticker. Race is caused by two timeouts being scheduled at the same time.
  ([\#3092](https://github.com/KYVENetwork/dydx-cometbft/pull/2136))
- `[types]` Do not batch verify a commit if the validator set keys have different
  types. ([\#3195](https://github.com/KYVENetwork/dydx-cometbft/issues/3195)
...
- `[privval]` Retry accepting a connection ([\#2047](https://github.com/KYVENetwork/dydx-cometbft/pull/2047))
- `[state]` Fix rollback to a specific height
  ([\#2136](https://github.com/KYVENetwork/dydx-cometbft/pull/2136))

### FEATURES

- `[e2e]` Add `block_max_bytes` option to the manifest file.
  ([\#2362](https://github.com/KYVENetwork/dydx-cometbft/pull/2362))

### IMPROVEMENTS

- `[blocksync]` Avoid double-calling `types.BlockFromProto` for performance
  reasons ([\#2016](https://github.com/KYVENetwork/dydx-cometbft/pull/2016))
- `[e2e]` Add manifest option `load_max_txs` to limit the number of transactions generated by the
  `load` command. ([\#2094](https://github.com/KYVENetwork/dydx-cometbft/pull/2094))
- `[jsonrpc]` enable HTTP basic auth in websocket client ([#2434](https://github.com/KYVENetwork/dydx-cometbft/pull/2434))
- `[blocksync]` make the max number of downloaded blocks dynamic.
  ...
  [\#2467](https://github.com/KYVENetwork/dydx-cometbft/pull/2467)
- `[blocksync]` Request a block from peer B if we are approaching pool's height
  ...
  block [\#2475](https://github.com/KYVENetwork/dydx-cometbft/pull/2475)
- `[blocksync]` Request the block N from peer B immediately after getting
  `NoBlockResponse` from peer A
  [\#2475](https://github.com/KYVENetwork/dydx-cometbft/pull/2475)
...
- `[consensus]` Add `chain_size_bytes` metric for measuring the size of the blockchain in bytes
  ([\#2093](https://github.com/KYVENetwork/dydx-cometbft/pull/2093))
...
`github.com/KYVENetwork/dydx-cometbft/store`. This function changed its signature in `v0.38.3`.
...
([ASA-2024-001](https://github.com/KYVENetwork/dydx-cometbft/security/advisories/GHSA-qr8r-m495-7hc4)).
...
- `[mempool]` Fix data races in `CListMempool` by making atomic the types of `height`, `txsBytes`, and
  `notifiedTxsAvailable`. ([\#642](https://github.com/KYVENetwork/dydx-cometbft/pull/642))
- `[mempool]` The calculation method of tx size returned by calling proxyapp should be consistent with that of mempool
  ([\#1687](https://github.com/KYVENetwork/dydx-cometbft/pull/1687))
- `[evidence]` When `VerifyCommitLight` & `VerifyCommitLightTrusting` are called as part
  ...
  ([\#1749](https://github.com/KYVENetwork/dydx-cometbft/pull/1749))
- `[crypto]` `SupportsBatchVerifier` returns false
  if public key is nil instead of dereferencing nil.
  ([\#1825](https://github.com/KYVENetwork/dydx-cometbft/pull/1825))
...
- `[store]` Save block using a single DB batch if block is less than 640kB, otherwise each block part is saved individually
  ([\#1755](https://github.com/KYVENetwork/dydx-cometbft/pull/1755))
- `[rpc]` Support setting proxy from env to `DefaultHttpClient`.
  ([\#1900](https://github.com/KYVENetwork/dydx-cometbft/pull/1900))
- `[rpc]` Use default port for HTTP(S) URLs when there is no explicit port ([\#1903](https://github.com/KYVENetwork/dydx-cometbft/pull/1903))
...
- `[mempool]` Avoid infinite wait in transaction sending routine when
  ...
  ([\#1654](https://github.com/KYVENetwork/dydx-cometbft/pull/1654))
...
- `[state/indexer]` Respect both height params while querying for events
   ([\#1529](https://github.com/KYVENetwork/dydx-cometbft/pull/1529))

### FEATURES

- `[metrics]` Add metric for mempool size in bytes `SizeBytes`.
  ([\#1512](https://github.com/KYVENetwork/dydx-cometbft/pull/1512))
...
- `[mempool]` Add experimental feature to limit the number of persistent peers and non-persistent
  ...
  ([\#1558](https://github.com/KYVENetwork/dydx-cometbft/pull/1558))
  ([\#1584](https://github.com/KYVENetwork/dydx-cometbft/pull/1584))
...
- `[protobuf]` Remove fields `sender`, `priority`, and `mempool_error` from
  `ResponseCheckTx`. ([\#260](https://github.com/KYVENetwork/dydx-cometbft/issues/260))
...
for people who forked CometBFT and interact directly with the indexers kvstore.
  ([\#774](https://github.com/KYVENetwork/dydx-cometbft/pull/774))
...
- `[pubsub]` Added support for big integers and big floats in the pubsub event query system.
  ...
  ([\#797](https://github.com/KYVENetwork/dydx-cometbft/pull/797))
...
- `[p2p]` Remove UPnP functionality
  ([\#1113](https://github.com/KYVENetwork/dydx-cometbft/issues/1113))
- `[node]` Removed `ConsensusState()` accessor from `Node`
  struct - all access to consensus state should go via the reactor
  ([\#1120](https://github.com/KYVENetwork/dydx-cometbft/pull/1120))
- `[state]` Signature of `ExtendVote` changed in `BlockExecutor`.
  ...
  ([\#1270](https://github.com/KYVENetwork/dydx-cometbft/pull/1270))
...
- `[kvindexer]` Forward porting the fixes done to the kvindexer in 0.37 in PR \#77
  ([\#423](https://github.com/KYVENetwork/dydx-cometbft/pull/423))
- `[consensus]` Unexpected error conditions in `ApplyBlock` are non-recoverable, so ignoring the error and carrying on is a bug. We replaced a `return` that disregarded the error by a `panic`.
  ([\#496](https://github.com/KYVENetwork/dydx-cometbft/pull/496))
- `[consensus]` Rename `(*PeerState).ToJSON` to `MarshalJSON` to fix a logging data race
  ([\#524](https://github.com/KYVENetwork/dydx-cometbft/pull/524))
...
- `[abci]` Restore the snake_case naming in JSON serialization of
  `ExecTxResult` ([\#855](https://github.com/KYVENetwork/dydx-cometbft/issues/855)).
- `[consensus]` Avoid recursive call after rename to (*PeerState).MarshalJSON
  ([\#863](https://github.com/KYVENetwork/dydx-cometbft/pull/863))
- `[mempool/clist_mempool]` Prevent a transaction to appear twice in the mempool
  ([\#890](https://github.com/KYVENetwork/dydx-cometbft/pull/890): @otrack)
...
- `[rpc/grpc]` Mark the gRPC broadcast API as deprecated.
  ...
  [\#81](https://github.com/KYVENetwork/dydx-cometbft/issues/81)
  ([\#650](https://github.com/KYVENetwork/dydx-cometbft/issues/650))
...
- `[proxy]` Introduce `NewConnSyncLocalClientCreator`, which allows local ABCI
  ...
  and [\#1145](https://github.com/KYVENetwork/dydx-cometbft/pull/1145))
...
- `[consensus]` New metrics (counters) to track duplicate votes and block parts.
  ([\#896](https://github.com/KYVENetwork/dydx-cometbft/pull/896))
- `[mempool]` Application can now set `ConsensusParams.Block.MaxBytes` to -1
...
- `[state]` Make logging `block_app_hash` and `app_hash` consistent by logging them both as hex.
  ([\#1264](https://github.com/KYVENetwork/dydx-cometbft/pull/1264))
...
- The `TMHOME` environment variable was renamed to `CMTHOME`, and all environment variables starting with `TM_` are instead prefixed with `CMT_`
  ([\#211](https://github.com/KYVENetwork/dydx-cometbft/issues/211))
- `[p2p]` Reactor `Send`, `TrySend` and `Receive` renamed to `SendEnvelope`,
  ...
  ([\#230](https://github.com/KYVENetwork/dydx-cometbft/pull/230))
- Bump minimum Go version to 1.20
  ([\#385](https://github.com/KYVENetwork/dydx-cometbft/issues/385))
...
- `[state/kvindexer]` Fixed the default behaviour of the kvindexer to index and
  ...
  ([\#77](https://github.com/KYVENetwork/dydx-cometbft/pull/77))
- `[state/kvindexer]` Resolved crashes when event values contained slashes,
  introduced after adding event sequences in
  [\#77](https://github.com/KYVENetwork/dydx-cometbft/pull/77). @jmalicevic
  ([\#382](https://github.com/KYVENetwork/dydx-cometbft/pull/382))
- `[consensus]` ([\#386](https://github.com/KYVENetwork/dydx-cometbft/pull/386)) Short-term fix for the case when `needProofBlock` cannot find previous block meta by defaulting to the creation of a new proof block. (@adizere)
...
- `[tools/tm-signer-harness]` Remove the folder as it is unused
  ([\#136](https://github.com/KYVENetwork/dydx-cometbft/issues/136))
- `[p2p]` Reactor `Send`, `TrySend` and `Receive` renamed to `SendEnvelope`,
  `TrySendEnvelope` and `ReceiveEnvelope` to allow metrics to be appended to
  messages and measure bytes sent/received.
  ([\#230](https://github.com/KYVENetwork/dydx-cometbft/pull/230))
...
- Rename binary to `cometbft` and Docker image to `cometbft/cometbft`
  ([\#152](https://github.com/KYVENetwork/dydx-cometbft/pull/152))
...
- Use Go 1.19 to build CometBFT, since Go 1.18 has reached end-of-life.
  ([\#360](https://github.com/KYVENetwork/dydx-cometbft/issues/360))
...
- `[state/kvindexer]` Resolved crashes when event values contained slashes,
  ...
  (\#[383](https://github.com/KYVENetwork/dydx-cometbft/pull/383): @jmalicevic)
- `[consensus]` Short-term fix for the case when `needProofBlock` cannot find
  ...
  ([\#386](https://github.com/KYVENetwork/dydx-cometbft/pull/386): @adizere)
...
- Replace [tm-db](https://github.com/tendermint/tm-db) with
  ...
  ([\#160](https://github.com/KYVENetwork/dydx-cometbft/pull/160))
- Bump tm-load-test to v1.3.0 to remove implicit dependency on Tendermint Core
  ([\#165](https://github.com/KYVENetwork/dydx-cometbft/pull/165))
- `[crypto]` Update to use btcec v2 and the latest btcutil
...
- Append the commit hash to the version of CometBFT being built
  ([\#204](https://github.com/KYVENetwork/dydx-cometbft/pull/204))
- `[mempool/v1]` Suppress "rejected bad transaction" in priority mempool logs by
  reducing log level from info to debug
  ([\#314](https://github.com/KYVENetwork/dydx-cometbft/pull/314): @JayT106)
