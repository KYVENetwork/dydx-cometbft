...
import (
	...
	cmtevents "github.com/KYVENetwork/dydx-cometbft/libs/events"
	"github.com/KYVENetwork/dydx-cometbft/libs/fail"
...
func (cs *State) needProofBlock(height int64) bool {
	...
	if lastBlockMeta == nil {
		// See https://github.com/KYVENetwork/dydx-cometbft/issues/370
...
func (cs *State) voteTime() time.Time {
	...
	// even if cs.LockedBlock != nil. See https://github.com/KYVENetwork/dydx-cometbft/tree/v0.38.x/spec/.
	if cs.LockedBlock != nil {
		// See the BFT time spec
		// https://github.com/KYVENetwork/dydx-cometbft/blob/v0.38.x/spec/consensus/bft-time.md
